...
import {
    ...
    FaCode,FaDesktop,FaStar,FaTrash,FaCheck,FaMagic
} from "react-icons/fa";
...
import {
    createProject,deleteProject,getProjects,getStarredProject,toggleStar
...
const Navbar=()=>{
    ...
    useEffect(()=>{
        const outside=event=>{
            ...
            if(
                starMenuRef.current&&
                !starMenuRef.current.contains(event.target)
            ){
                setStarOpen(false);
            }
        };
    ...
    useEffect(()=>{
        ...
        window.addEventListener("zs-code-projects-updated",update);

        return()=>{
            window.removeEventListener("zs-code-projects-updated",update);
        };
    },[user]);

    useEffect(()=>{
        const openProject=event=>{
            setActiveProject(event.detail||null);
        };

        const deleteProjects=event=>{
    ...
    /*
     * Preview mounts after the original open-project event has already
     * happened. It asks Navbar for the currently active project.
     */
    useEffect(()=>{
        const requestActiveProject=()=>{
    ...
    const handleCreateProject=async(name,description)=>{
        try{
            ...
            window.dispatchEvent(
                new CustomEvent("zs-code-projects-updated")
            );
    ...
    const handleDeleteSelected=async()=>{
        ...
        try{
            ...
            const successfulIds=selectedProjects.filter(
                (id,index)=>Boolean(results[index])
            );
            ...
            setProjects(prev=>
                prev.filter(
                    project=>!successfulIds.includes(project._id)
                )
            );
    ...
    const ProjectRow=({
        ...
        <div
            onClick={()=>
                !selectable&&handleOpenProject(project)
            }
            className={`flex items-center gap-2 rounded-xl px-2.5 py-2 transition-all duration-200 ${
    ...
    return(
        <>
            <nav className="fixed left-0 right-0 top-0 z-50">
                <div
                    className={`mx-auto flex h-[50px] max-w-[1550px] items-center justify-between border-b px-4 transition-all duration-500 sm:px-5 ${
                        isDark
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <button
                                ...
                                className={`flex h-8 items-center gap-2 rounded-md border px-3 transition-all ${
                                    homeOpen
                                        ?isDark
                            ...
                            {homeOpen&&(
                                <div
                                    className={`absolute left-0 top-[calc(100%+12px)] w-[310px] overflow-hidden rounded-[20px] p-2 effect-3d backdrop-blur-3xl ${
                                        isDark
                                            ?"bg-[#393636]"
                                ...
                                >
                                    ...
                                    {!user?(
                                        <div
                                            className={`px-3 py-8 text-center font-plex text-[15px] ${
                                                isDark
                                                    ?"text-white/40"
                                                    :"text-slate-400"
                                            }`}
                                        ...
                                        <>
                                            <div className="mb-2 flex gap-2 px-1">
                                                <button
                                                    ...
                                                    className="effect-3d font-plex flex h-9 flex-1 items-center justify-center gap-1 rounded-full bg-gradient-to-r from-[#0b165d] via-[#1227b2] to-[#0641e2] px-2 text-xl tracking-widest text-white"
                                                >
                                                    Create
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    className={`effect-3d font-plex flex h-9 items-center justify-center rounded-full px-4 text-xl tracking-widest text-white ${
                                                        selectionMode
                                                            ?"bg-rose-600"
                                                ...
                                                {projectsLoading?(
                                                    ...
                                                    projects.map(
                                                        (project,index)=>(
                                                            <div
                                                                key={project._id}
                                                                className={`mt-2 flex items-center gap-0 rounded-4xl px-2.5 py-0.5 ${
                                                                    isDark
                                                                        ?"bg-black/[0.5]"
                                                                        :"bg-black/[0.03]"
                                                                }`}
                                                            >
                                                                <span
                                                                    className={`w-5 text-center text-[14px] font-semibold font-plex ${
                                                                        isDark
                                                                            ?"text-white"
                                                                            :"text-slate-400"
                                                                    }`}
                                            ...
                                            {selectionMode&&(
                                                <button
                                                    ...
                                                    className="effect-3d font-plex mt-2 flex h-9 w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-red-700 via-red-600 to-red-700 text-xs font-semibold text-white disabled:cursor-not-allowed disabled:opacity-40"
                                                >
                        ...
                        >
                            <button
                                ...
                                className={`ml-1 flex h-8 w-8 items-center justify-center rounded-md border transition-all duration-200 ${
                                    starOpen
                                        ?isDark
                            ...
                            {starOpen&&(
                                <div
                                    className={`absolute left-0 top-[calc(100%+12px)] w-[290px] overflow-hidden rounded-[20px] border p-2 effect-3d backdrop-blur-3xl ${
                                        isDark
                                ...
                                >
                                    <div className="flex items-center gap-2 px-2 py-1">
                                        ...
                                        <span
                                            className={`font-plex tracking-wider font-semibold ${
                                                isDark
                                                    ?"text-white"
                                                    :"text-slate-800"
                                            }`}
                                    ...
                                    {!user?(
                                        ...
                                        <div className="max-h-[350px] overflow-hidden">
                                            {starredLoading?(
                                                ...
                                                <div
                                                    className={`px-3 py-8 text-center text-[16px] font-plex ${
                                                        isDark
                                                            ?"text-white/40"
                                                            :"text-slate-400"
                                                    }`}
                        ...
                        <div className="ml-2 flex items-center gap-3 p-0.5">
                            <button
                                ...
                                className={`flex h-8 items-center gap-1.5 rounded-sm border border-purple-300/20 px-3 font-plex text-[17px] transition-all duration-300 ${
                                    viewMode==="code"
                                        ?isDark
                            ...
                            <button
                                ...
                                className={`flex h-8 items-center gap-1.5 rounded-sm border border-blue-200/20 px-2 font-plex text-[17px] transition-all duration-300 ${
                                    viewMode==="preview"
                                        ?isDark
                            ...
                            <button
                                ...
                                className={`group relative flex h-8 w-8 items-center justify-center overflow-hidden rounded-md border transition-all duration-300 ${
                                    aiOpen
                    ...
                    <div className="flex items-center gap-2 sm:gap-10">
                        <button
                            ...
                            className={`group relative h-6 w-12 overflow-hidden rounded-[20px] border transition-all duration-500 ${
                                isDark
                        ...
                        >
                            <span
                                className={`absolute top-0 flex h-full w-6 items-center justify-center rounded-[20px] transition-all duration-500 ${
                                    isDark
                                        ?"left-0 bg-[#3155ff]"
                            ...
                            >
                                {isDark
                                    ?<FaMoon className="text-[13px] text-white/90"/>
                                    :<FaSun className="text-[10px] text-black/80"/>
                                }
                            </span>
                        </button>
                        ...
                        {!user?(
                            <div className="flex items-center gap-2 sm:gap-3">
                                <button
                                    ...
                                    className="flex h-11 items-center justify-center rounded-md bg-blue-700 effect-3d px-4 font-plex text-[22px] tracking-wide text-white transition-all duration-300 hover:scale-[1.03] sm:h-8 sm:px-3 sm:text-[19px]"
                                >
                                    Login
                                </button>
                                ...
                                <button
                                    ...
                                    className="flex h-11 items-center justify-center rounded-md bg-purple-700 effect-3d px-4 font-plex text-[22px] tracking-wide text-white transition-all duration-300 hover:scale-[1.03] sm:h-8 sm:px-3 sm:text-[19px]"
                                >
                                    Sign Up
                                </button>
                            </div>
                            ...
                            >
                                <button
                                    ...
                                    className={`font-plex flex h-11 items-center gap-2 rounded-md border px-1.5 py-1.5 backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] sm:h-10 sm:gap-2.5 sm:pl-1.5 sm:pr-3 ${
                                        isDark
                                ...
                                >
                                    <div
                                        className={`flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full border text-[11px] font-bold sm:h-8 sm:w-8 sm:text-xs ${
                                            isDark
                                    ...
                                    <span
                                        className={`hidden max-w-[100px] truncate text-sm font-semibold sm:block ${
                                            isDark
                                                ?"text-white"
                                                :"text-black"
                                        }`}
                                    ...
                                    <FaChevronDown
                                        className={`mr-1 text-[10px] transition-transform ${
                                            open
                                                ?"rotate-180"
                                                :""
                                        }`}
                                ...
                                {open&&(
                                    <div
                                        className={`absolute right-0 top-[calc(100%+10px)] w-[300px] overflow-hidden rounded-xl border p-2 effect-less ${
                                            isDark
                                    ...
                                    >
                                        ...
                                        >
                                            <p
                                                className={`text-[12px] font-bold font-plex tracking-[0.18em] ${
                                                    isDark
                                                        ?"text-white/50"
                                                        :"text-blue-700"
                                                }`}
                                            ...
                                            <p
                                                className={`font-plex mt-1 text-3xl tracking-wider ${
                                                    isDark
                                                        ?"text-white"
                                                        :"text-slate-900"
                                                }`}
                                            ...
                                            <p
                                                className={`font-plex mt-0.5 truncate text-[14px] tracking-wider ${
                                                    isDark
                                                        ?"text-slate-400"
                                                        :"text-slate-500"
                                                }`}
                                        ...
                                        <button
                                            ...
                                            className={`font-tangerine mt-2 flex w-full items-center gap-2.5 rounded-[20px] px-23 py-1 text-2xl font-bold tracking-wider effect-3d transition-all duration-300 ${
                                                isDark
