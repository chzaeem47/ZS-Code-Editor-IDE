...
const ProcessManager=({
    ...
    useEffect(()=>{
        ...
        const handleStarted=processInfo=>{
            if(
                String(
    ...
    return(
        <div
            className={`absolute bottom-3 right-3 z-50 w-[360px] overflow-hidden rounded-xl border shadow-2xl ${
                isDark
        ...
        >
            ...
            <div
                className={`flex gap-2 border-y p-2 ${
                    isDark
                        ? "border-white/10"
                        : "border-black/10"
                }`}
            >
                ...
                <input
                    ...
                    placeholder="run dev"
                    className={`min-w-0 flex-[1.4] rounded-md px-2 py-1 text-[11px] outline-none ${
                        isDark
                            ? "bg-[#101010] text-white placeholder:text-white/20"
                            : "bg-slate-100 text-slate-800 placeholder:text-slate-400"
                    }`}
            ...
            <div className="max-h-56 overflow-y-auto">
                {processes.length===0 ? (
                    <div
                        className={`px-3 py-5 text-center font-plex text-[10px] ${
                            isDark
                                ? "text-white/30"
                                : "text-slate-400"
                        }`}
                    ...
                    processes.map(process=>(
                        ...
                        >
                            <div className="min-w-0">
                                <div
                                    className={`truncate font-plex text-[11px] ${
                                        isDark
                                            ? "text-white/80"
                                            : "text-slate-700"
                                    }`}
                                ...
                                <div
                                    className={`flex gap-2 font-plex text-[9px] ${
                                        isDark
                                            ? "text-white/30"
                                            : "text-slate-400"
                                    }`}
