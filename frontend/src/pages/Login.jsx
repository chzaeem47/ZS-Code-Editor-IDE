...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      >
        {isDark ? (
          <FaMoon className="h-[20px] w-[20px] text-cyan-200 transition-all duration-300" />
        ) : (
          <FaSun className="h-[20px] w-[20px] text-yellow-200 transition-all duration-300" />
        )}
      </button>
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <div className="group relative rounded-full border border-white/[0.18] bg-white/[0.10] shadow-inner shadow-white/[0.04] transition-all duration-300 hover:bg-white/[0.14] focus-within:border-cyan-300/60 focus-within:bg-white/[0.15]">
                  ...
                  <TfiEmail className="pointer-events-none absolute left-5 top-1/2 h-[19px] w-[19px] -translate-y-1/2 text-white/70 transition-colors duration-300 group-focus-within:text-cyan-300" />
                ...
                <div className="group relative rounded-full border border-white/[0.18] bg-white/[0.10] shadow-inner shadow-white/[0.04] transition-all duration-300 hover:bg-white/[0.14] focus-within:border-cyan-300/60 focus-within:bg-white/[0.15]">
                  ...
                  <MdLockOutline className="pointer-events-none absolute left-5 top-1/2 h-[21px] w-[21px] -translate-y-1/2 text-white/70 transition-colors duration-300 group-focus-within:text-cyan-300" />
                ...
                <div className="flex justify-end px-2 pt-1">
                  <button
                    ...
                    className="font-serif text-[14px] italic text-cyan-300 transition-colors duration-300 hover:text-cyan-200"
                  >
                    Forgot Password?
                  </button>
                </div>
